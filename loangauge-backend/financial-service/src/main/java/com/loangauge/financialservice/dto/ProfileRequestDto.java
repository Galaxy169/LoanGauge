...
public record ProfileRequestDto(
        ...
        @Max(value = 20, message = "Dependents value looks invalid")
        Integer dependents,
        ...
        @Max(value = 60, message = "Work experience value looks invalid")
        Integer workExperienceYears,

        @NotBlank(message = "Income stability is required")
        @Size(max = 30)
        ...
        @DecimalMin(value = "0.0", inclusive = true, message = "Monthly EMI cannot be negative")
        BigDecimal monthlyEmi,

        @NotNull(message = "Credit card balance is required")
        @DecimalMin(value = "0.0", inclusive = true, message = "Credit card balance cannot be negative")
        BigDecimal creditCardBalance,

        @NotNull(message = "Savings is required")
        @DecimalMin(value = "0.0", inclusive = true, message = "Savings cannot be negative")
        BigDecimal savings,

        @DecimalMin(value = "0.0", inclusive = true, message = "Fixed deposits cannot be negative")
        BigDecimal fixedDeposits,

        @DecimalMin(value = "0.0", inclusive = true, message = "Investments cannot be negative")
        BigDecimal investments,

        @NotNull(message = "Emergency fund is required")
        @DecimalMin(value = "0.0", inclusive = true, message = "Emergency fund cannot be negative")
        ...
        @NotNull(message = "Credit utilization is required")
        @DecimalMin(value = "0.0", inclusive = true, message = "Credit utilization must be between 0 and 100")
        @DecimalMax(value = "100.0", inclusive = true, message = "Credit utilization must be between 0 and 100")
